...
internal enum FontFamily {
  ...
  internal static let allCustomFonts: [FontConvertible] = [AppleSDGothicNeoI.all, AppleSDGothicNeo.all, NanumMyeongjo.all, Pretendard.all, OmyuPretty.all].flatMap { $0 }
